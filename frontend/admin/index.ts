...
try {
  ...
  box.innerHTML = `
    <a class="card" href="./adjustments.html"><h2>Adjustment approvals</h2><p style="color:${pending.length ? "var(--err)" : "inherit"}">${pending.length} requests awaiting approval</p></a>
